...
extension CashoutTipVC: MSCircularSliderDelegate {
    func circularSlider(_ slider: MSCircularSlider, valueChangedTo value: Double, fromUser: Bool) {
        ...
        if value >= 2 && value < 4 {
            emoWorriedView.active("sad")
            emoSmileView.inactive("smile")
            emoLoveView.inactive("love")
            emoBlushView.inactive("blush")
            emoHeartView.inactive("happy")
        } else if value >= 4 && value < 8 {
            emoWorriedView.inactive("sad")
            emoSmileView.active("smile")
            emoLoveView.inactive("love")
            emoBlushView.inactive("blush")
            emoHeartView.inactive("happy")
            ...
            emoLoveView.inactive("love")
            emoBlushView.inactive("blush")
            emoHeartView.active("happy")
        } else if value >= 12 {
            emoWorriedView.inactive("sad")
            emoSmileView.inactive("smile")
            emoLoveView.active("love")
            emoBlushView.inactive("blush")
            emoHeartView.inactive("happy")
        }
    }
