...
//            currentValue = valueFrom(angle: angle)
    ...
    public var startAngle: CGFloat {
        return clockwise ? spaceDegree : 180 - spaceDegree
    }
    
    public var endAngle: CGFloat {
        return clockwise ? 180 - spaceDegree : spaceDegree
    }
...
//        }
    ...
    internal func drawLine(ctx: CGContext) {
        ...
        drawUnfilledCircle(ctx: ctx, center: centerPoint, radius: calculatedRadius, lineWidth: CGFloat(lineWidth), minimumAngle: CGFloat(minimumAngle), maximumAngle: maximumAngle, lineCap: unfilledLineCap)
