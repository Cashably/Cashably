...
public class MSDoubleHandleCircularSlider: MSCircularSlider {
    ...
    override func drawLine(ctx: CGContext) {
        ...
        drawUnfilledCircle(ctx: ctx, center: centerPoint, radius: calculatedRadius, lineWidth: CGFloat(lineWidth), minimumAngle: minimumAngle, maximumAngle: maximumAngle, lineCap: unfilledLineCap)
